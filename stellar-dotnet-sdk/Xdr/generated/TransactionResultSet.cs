...
//  ===========================================================================
    public class TransactionResultSet
    {
        ...
        public static void Encode(XdrDataOutputStream stream, TransactionResultSet encodedTransactionResultSet)
        {
            ...
            for (var i = 0; i < resultssize; i++) TransactionResultPair.Encode(stream, encodedTransactionResultSet.Results[i]);
        }
        ...
        public static TransactionResultSet Decode(XdrDataInputStream stream)
        {
            ...
            for (var i = 0; i < resultssize; i++) decodedTransactionResultSet.Results[i] = TransactionResultPair.Decode(stream);
